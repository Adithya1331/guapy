...
from .exceptions import (
    ...
    GuapyUpstreamTimeoutError, GuapyForbiddenError, GuapyServerError,
    GuapyResourceClosedError, GuapyUpstreamNotFoundError, 
    GuapyUpstreamUnavailableError, GuapyClientTimeoutError,
    GuapyClientOverrunError, GuapyClientBadTypeError
)
